...
function addRequest(request as Object) as Boolean
  ...
  if type(request) = "roAssociativeArray" then
    ...
    if type(context) = "roSGNode"
      ...
      ' The context's "parameters" property value is an associative array with two properties:
      ...
      if type(parameters) = "roAssociativeArray" then
        ...
        if type(uri) = "roString" then
          ...
          ' When the GET completes, a roUrlEvent will be sent to the message port associated with the object.
          ' The event will contain a roString with the body of the response.
...
sub processResponse(message as Object)
  ...
  ' Find the transfer job assoicated with the idKey
